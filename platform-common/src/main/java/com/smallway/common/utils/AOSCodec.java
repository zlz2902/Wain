...
public class AOSCodec {
	...
	private final static Logger logger = LoggerFactory.getLogger(AOSCodec.class);
	...
	private static String code_key = "HY&XC&MW";
	...
	*/
	...
	public static String password(String password) {
		return md5(encrypt(password, code_key));
	}
	...
	*/
	public static void main(String[] args) throws IOException {
	   ...
	   for ( int i = 0 ; i < 1 ; i ++) {   
	    ...
	    System.out.println(md5(strEncrypto));
