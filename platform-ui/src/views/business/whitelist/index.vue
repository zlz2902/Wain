    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['business:whitelist:add']"
        >录入</el-button>
      </el-col>
      ...
      <el-table-column label="操作" align="center" fixed="right" min-width="180">
        <template slot-scope="scope">
          ...
          <el-button
            ...
            v-hasPermi="['business:whitelist:edit']"
          >编辑</el-button>
          <el-button
            size="mini"
            type="text"
            ...
            v-hasPermi="['business:whitelist:remove']"
          >删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
import { listWhitelist, getWhitelist, delWhitelist, addWhitelist, updateWhitelist, listInfo } from "@/api/business/whitelist";
import {clearCurrentToken} from "@/utils/submitToken";
    ...
    submitForm() {
      this.$refs["form"].validate(valid => {
        if (valid) {
          ...
          const requestMethod = this.form.id != null ? updateWhitelist : addWhitelist;

          requestMethod(this.form)
            .then(() => {
            ...
            .finally(() => {
              this.submitLoading = false; // 结束加载状态
            });
        }
      });
    },
