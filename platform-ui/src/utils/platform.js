...
export async function getCard(data) {
  ...
  await  this.$axios({
    method: "GET",//指定请求方式
    url: "http://localhost:8080/GetICNO",//请求接口（相对接口，后面会介绍到）
  })//面向1-3年前端人员
    .then(function(res){
      //接口成功返回结果执行
      console.log(res)
      console.log(res.data.ICNO)
      console.log(res.data.ICSN)
      // data.inscard=res.data.ICNO;
      // data.sncard=res.data.ICSN;
      result= res.data
    })
    .catch(function(err){
      console.log(err)
...
export async function getCardNo(){
